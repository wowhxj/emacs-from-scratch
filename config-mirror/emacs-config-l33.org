...
- [[#init-toolsel][init-tools.el]]
  ...
  - [[#sdcv本地词典][sdcv本地词典]]
  - [[#fanyi在线词典][fanyi在线词典]]
  - [[#org-ai智能助手][org-ai智能助手]]
  - [[#pass密码管理][pass密码管理]]
  - [[#nov-epub阅读器][nov epub阅读器]]
  - [[#calibredbel图书管理][calibredb.el图书管理]]
  - [[#mpviel视频管理][mpvi.el视频管理]]
...
- [[#init-browserel][init-browser.el]]
  - [[#init-browserel-文件头][init-browser.el 文件头]]
  - [[#eww-配置][EWW 配置]]
  - [[#eaf-配置][EAF 配置]]
  - [[#init-browserel-文件尾][init-browser.el 文件尾]]
